...
<html>
    <head>
        ...
        <style>
            ...
            .admin_rep_loc_box:hover{
                background-color: #1f8db3;
            }
            .admin_rep_amount_box{
                margin-left: 20px;
                /*margin-top: 3px;*/
                clear: both;
                width: 100px;
...
// </editor-fold>
                $obj = new Reports();
                $obj->det_by_click_type_project_admin($_SESSION['report_budgetid'], $_SESSION['report_locationid']);
            ?>
