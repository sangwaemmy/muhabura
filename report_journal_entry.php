...
<html>
    ...
    <div class="parts eighty_centered heit_free no_paddin_shade_no_Border  margin_free accept_abs" >
        ...
        <div class="parts full_center_two_h heit_free no_paddin_shade_no_Border margin_free row_underline">
            <div class="parts seventy_centered no_paddin_shade_no_Border  margin_free ">
...
//            $tot_cogs = $opening_stock + $purchase_ofperiod - $closing_stock; //This is wrong
            ...
            // update from bojos
            $sum_interest_income=$other->get_interest_income_by_date($start_date, $end_date); 
            $sum_income_tax = $other->get_income_tax_by_date($start_date, $end_date);
        ...
        <div class="parts seventy_centered no_shade_noBorder">
            ...
            <table   class="income_table2">
                ...
                <tr class="row_bold row_underline group_label balnc_gen_exp">  <td><b> General & administrative   </b></td><td class="note_cells">4</td><td> <?php echo number_format($gen_expenses) ?></td>      </td> 
                </tr>
            ...
            <!--update from  bojos -->
                <tr class="row_bold group_label padding_top balnc_interest_income">  <td><b>  Interest income </b></td><td class="note_cells">5</td> <td><?php echo number_format($sum_interest_income) ?></td>                                                </td> 
                </tr>
                <tr class="row_bold group_label row_underline balnc_income_tx">  <td>   Income tax  </td><td class="note_cells">6</td><td><?php echo number_format($sum_income_tax) ?></td>     
                    </td> 
                </tr>
            <!-- End for the income statement update from  bojos -->
