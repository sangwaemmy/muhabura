    ...
    class Continuos_form {
        ...
        function get_on_salesorder_from_quototion($quotation) {
            try {
                ...
                $sql = " SELECT sales_quote_line.sales_quote_line_id,  sales_quote_line.quantity,  sales_quote_line.unit_cost,  sales_quote_line.entry_date,  sales_quote_line.User,  sales_quote_line.amount,  measurement.code as measurement,p_budget_items.item_name as item FROM accounting_db.sales_quote_line  "
