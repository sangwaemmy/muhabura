        ...
        <div class="parts eighty_centered no_paddin_shade_no_Border accept_abs">
            <div class="parts full_center_two_h heit_free margin_free no_paddin_shade_no_Border row_underline">
                <div class="parts ninenty_centered heit_free no_paddin_shade_no_Border ">
                    <table border="1" class="full_center_two_h heit_free margin_free no_paddin_shade_no_Border">
                        <td><?php // echo 'The start date'.start_date().'  '.end_date(); ?><select class="cbo_rep_period_options">
                                <option>All</option>
                                <option>Today</option>
            ...
            <?php
                ...
                $sum_fixed_asst =  $other->get_sum_fixed_assets_by_date($min_date, $max_date);
                $sum_current_asset = $other->get_sum_current_assets_by_date($min_date, $max_date);
                $sum_acc_depreciation = $other->get_sum_acc_depreciation_by_date($min_date, $max_date);
                ...
                $sum_share_capital=$other->get_capital_stock_by_date($min_date, $max_date);                
            ...
            <div class="parts eighty_centered heit_free no_paddin_shade_no_Border ">
                ...
                <div class="parts no_shade_noBorder">
                    ...
                    <table class="income_table2">
                        ...
                        <tr class="row_bold padding_top group_label inc_other_c_assets">
                        ...
                        <tr class="row_bold row_underline group_label inc_accumulated_deprec">
                            <td>Accumulated depreciation</td><td><?php echo number_format($sum_acc_depreciation);?></td>
                        </tr>
                        <tr class="row_bold  ">
                ...
                <div class="parts no_shade_noBorder ">
                    ...
                    <table class="income_table2">
                        ...
                        <tr class="row_bold group_label inc_capital_stock"> <td>Capital stock</td><td> <?php echo number_format($sum_share_capital); ?></td>
                        </tr>
                        <tr class="row_bold row_underline group_label in"> <td>Retained earnings</td><td> <?php echo number_format($sum_long_term_debt); ?></td>
                        </tr>
