            ...
            <div class="parts full_center_two_h heit_free margin_free no_paddin_shade_no_Border row_underline">
                <div class="parts ninenty_centered heit_free no_paddin_shade_no_Border ">
                    <table border="1" class="full_center_two_h heit_free margin_free no_paddin_shade_no_Border">
                        ...
                        </td> <td>Start date</td><td><input type="text" id="date1" value="<?php start_date(); ?>" class="textbox dates"></td>
                        <td>End date</td><td><input  type="text" id="date2" value="<?php end_date(); ?>" class="textbox dates"></td>
                        <td>
                            <select>
                ...
                <div class="parts no_shade_noBorder ">
                    ...
                    <table class="income_table2">
                        ...
                        <tr class="row_bold group_label inc_income_tx">
                            <td>Income taxes Payableable</td><td> <?php echo 0; ?></td>
                        </tr>
                        ...
                        <tr class="row_bold row_underline group_label inc_retained_earn"> <td>Retained earnings</td><td> <?php echo number_format($sum_retained_earnings); ?></td>
                        </tr>
