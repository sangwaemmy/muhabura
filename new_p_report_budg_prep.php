    ...
    <body>
        ...
        <form action="new_p_items_expenses.php" method="post" enctype="multipart/form-data">
            ...
            <div class="parts eighty_centered datalist_box" >
                <div class="parts no_shade_noBorder xx_titles no_bg whilte_text dataList_title">Budget Project Report</div>
                <div class="parts no_paddin_shade_no_Border page_search link_cursor">Search</div>
                <?php
                    require_once '../web_db/other_fx.php';
                    $obj = new other_fx();
                    $obj->list_p_budget_prep();
                ?>
            </div>  
        </form>
    ...
    <table class="margin_free">
        <td>
            <form action="../web_exports/excel_export.php" method="post">
                <input type="hidden" name="p_report_budg_prep" value="a"/>
                <input type="submit" name="export" class="btn_export btn_export_excel" value="Export"/>
            </form>
        </td>
        <td>
            <form action="../prints/print_p_report_budg_prep.php" method="post">
