    ...
    <body>
        ...
        <form action="new_p_items_expenses.php" method="post" enctype="multipart/form-data">
            ...
            <div class="parts eighty_centered off saved_dialog">
                p_items_expenses saved successfully!</div>


            <div class="parts eighty_centered new_data_box off">
                <div class="parts eighty_centered new_data_title">  Activities expenses Registration </div>

                <table class="new_data_table off">
                    <tr>
                        <td><a href="#" id="item_link" style="color: #060817;   ">Choose Item</a></td>
                        <td></td>
                    </tr>
            ...
            <div class="parts eighty_centered datalist_box" >
                <div class="parts no_shade_noBorder xx_titles no_bg whilte_text dataList_title">Project Report</div>
                <?php
                    $obj = new multi_values();
                    $first = $obj->get_first_p_items_expenses();
                    $obj->list_p_proj_report($first);
                ?>
            </div>  
        </form>
            ...
            <table class="margin_free">
                <td>
                    <form action="../web_exports/excel_export.php" method="post">
                        <input type="hidden" name="p_report" value="a"/>
                        <input type="submit" name="export" class="btn_export btn_export_excel" value="Export"/>
                    </form>
                </td>
                <td>
                    <form action="../prints/print_p_request.php" method="post">
